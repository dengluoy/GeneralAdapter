...
public class LinearHorizontalActivity extends AppCompatActivity implements TaskManager.OnTaskLoadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDataAdapter = new DataAdapter(this, R.layout.item_horizontal_text);
        mDataAdapter.setItemCickListener(new DataAdapter.OnItemClickListener() {
            ...
            public void onItemClick(SortedList list, DataAdapter.ViewHolder viewHolder, View view) {
                ...
                Toast.makeText(LinearHorizontalActivity.this, item.title, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mSeamlessAutoLoadRecyclerViewAdapter.setLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMoreData(RecyclerView recyclerView, RecyclerViewLoadingFooterView.State footerViewState) {
                ...
                if (mCurrentCounter < TOTAL_COUNTER) {
                    RecyclerViewScrollStateUtils.setFooterViewState(LinearHorizontalActivity.this, mRecyclerView, REQUEST_COUNT, RecyclerViewLoadingFooterView.State.Loading, null);
                    mTaskManager.requestData(mDataAdapter.getItemCount());
                } else {
                    RecyclerViewScrollStateUtils.setFooterViewState(LinearHorizontalActivity.this, mRecyclerView, REQUEST_COUNT, RecyclerViewLoadingFooterView.State.End, null);
                }
            }
        });
